...
public abstract class IFAAManager {
     ...
     */
    @UnsupportedAppUsage public abstract int getSupportBIOTypes(Context context);
     ...
     */
    @UnsupportedAppUsage public abstract int startBIOManager(Context context, int authType);
     ...
     */
    @UnsupportedAppUsage public native byte[] processCmd(Context context, byte[] param);

    /**
     * 获取设备型号，同一款机型型号需要保持一致
     */
    @UnsupportedAppUsage public abstract String getDeviceModel();

    /**
     * 获取IFAAManager接口定义版本，目前为1
     */
    @UnsupportedAppUsage public abstract int getVersion();
